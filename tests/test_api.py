...
class TestDocumentsCRUD:
    ...
    def test_get_document(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "Test", "cognitive_load": 8,
        })
    ...
    def test_list_documents(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "First", "cognitive_load": 8,
        })
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-002", "title": "Second", "cognitive_load": 5,
        })
    ...
    def test_update_document(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "Original", "cognitive_load": 8,
        })
...
class TestSearch:
    def test_search_by_zone(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "Green", "cognitive_load": 8,
        })
    ...
    def test_search_by_tag(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "Tagged", "cognitive_load": 8,
            "tags": ["api_test"],
        })
...
class TestZoneOps:
    ...
    def test_migrate_success(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "Migrate Me",
    ...
    def test_migrate_guard_violation(self, client):
        client.post("/api/documents", json={
            "doc_id": "TST-DOC-001", "title": "Stay Put",
            "cognitive_load": 8, "status": "DRAFT",
        })
        r = client.post("/api/migrate", json={
            "doc_id": "TST-DOC-001",
            "target_zone": "YELLOW",
